...
import { ShieldAlert, CheckCircle2, AlertCircle, Clock, Search, Filter, Ban, RefreshCw } from 'lucide-react';
...
function RTGSPanel({ currentUser }) {
    ...
    useEffect(() => {
        ...
        const unsubscribe = onSnapshot(
            ...
            (err) => {
                ...
                setLoading(false);
                // Call standard firebase integration skill error handler
                try {
    ...
    // Render access denied UI if not an admin
    if (!isAdmin) {
        return (
            ...
            <div className="flex flex-col sm:flex-row gap-3">
                <div className="relative flex-1">
                    ...
                    <input 
                        ...
                        className="input-field w-full pl-10 upper dark:bg-slate-900 dark:border-slate-800 dark:text-white"
                    />
                </div>
